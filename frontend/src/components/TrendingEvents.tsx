      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between mb-4">
          <span className="font-body text-xs text-text-secondary flex items-center gap-1.5">
            <svg viewBox="0 0 16 16" fill="none" className="w-3.5 h-3.5 text-text-muted" aria-hidden="true">
        ...
        >
          Get Tickets
          <svg viewBox="0 0 16 16" fill="none" className="w-3.5 h-3.5 transition-transform duration-200 group-hover:translate-x-0.5" aria-hidden="true">
...
export default function TrendingEvents() {
  return (
    <section className="bg-bg-primary py-16 sm:py-24 lg:py-28 px-5 md:px-10 lg:px-12" id="trending-section">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10 sm:mb-12">
          <div>
            <h2 className="font-display text-2xl sm:text-4xl font-bold tracking-tight text-text-primary mb-2" id="trending-title">
              Trending This Week
            </h2>
