...
function EventCard({
    ...
    return (
        <div
            ...
            className="group bg-surface border border-white/6 hover:border-gold/20 rounded-xl overflow-hidden cursor-pointer transition-all duration-350 hover:-translate-y-1.5 hover:shadow-[0_16px_48px_rgba(0,0,0,0.5)] opacity-0 translate-y-8 flex flex-col justify-between"
